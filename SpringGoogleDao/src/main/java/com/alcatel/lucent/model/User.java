 ...
 */
@Entity
@Table(name = "user", catalog = "tmf615", schema = "")
...
public class User implements Serializable {
    ...
    private Integer id;
    @Column(name = "ADRESS_FILTER", length = 255)
    private String adressFilter;
    @Column(name = "COMMAND_TIMEOUT")
    private Integer commandTimeout;
    @Column(name = "DESCRIPTION", length = 255)
    private String description;
    @Column(name = "INACTIVITY_TIMEOUT", length = 255)
    private String inactivityTimeout;
    @Column(name = "LOCKED")
    private Boolean locked;
    @Column(name = "LOGIN_MESSAGE", length = 255)
	...
	public String toString() {
		...
		builder.append(id);
		builder.append(", adressFilter=");
		builder.append(adressFilter);
		builder.append(", commandTimeout=");
		builder.append(commandTimeout);
		builder.append(", description=");
		builder.append(description);
		builder.append(", inactivityTimeout=");
		builder.append(inactivityTimeout);
		builder.append(", locked=");
		builder.append(locked);
		builder.append(", loginMessage=");
		builder.append(loginMessage);
		builder.append(", maxConcurrentSessions=");
		builder.append(maxConcurrentSessions);
		builder.append(", mustChangedPasswd=");
		builder.append(mustChangedPasswd);
		builder.append(", name=");
		builder.append(name);
		builder.append(", noPasswordExpiration=");
		builder.append(noPasswordExpiration);
		builder.append(", password=");
		builder.append(password);
		builder.append(", timeout=");
		builder.append(timeout);
		builder.append(", useGlobalCommandTimeout=");
		builder.append(useGlobalCommandTimeout);
		builder.append(", useGlobalLoginMessage=");
		builder.append(useGlobalLoginMessage);
		builder.append(", useInternalDbAuth=");
		builder.append(useInternalDbAuth);
		builder.append("]");
